...
from archs.rvrt_arch import RVRT as net
...
def main():
    ...
    parser.add_argument('--task', type=str, default='RVRT_REDS4', help='task name, used as the results/ subfolder')
    ...
    parser.add_argument('--model_path', type=str, default='pretrained/rvrt_reds_x4.pth', help='model path')
